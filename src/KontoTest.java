public class KontoTest {
    public static void main(String[] args) {
        ...
        unserKonto.auszahlen(200000);
        double saldo = unserKonto.getSaldo();
        System.out.println("Saldo: " + saldo);



        Konto kontoVonPeter = new Konto();
        kontoVonPeter.setKontonummer(333444);
        kontoVonPeter.setSaldo(100000);
        kontoVonPeter.einzahlen(1000);
